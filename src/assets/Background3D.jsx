    ...
    useFrame((state) => {
        if (meshRef.current) {
            ...
            meshRef.current.rotation.x +=
                (rotationSpeed.x + scrollRotation * 0.01) * speedMultiplier;
            meshRef.current.rotation.y +=
                (rotationSpeed.y + scrollRotation * 0.01) * speedMultiplier;
        }
    });
    ...
    useFrame((state) => {
        if (pointsRef.current) {
            pointsRef.current.rotation.y =
                state.clock.getElapsedTime() * 0.015 + scroll.offset * 0.5;
